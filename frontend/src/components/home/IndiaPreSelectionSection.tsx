            ...
            >
              ...
              <div className="mt-6 max-w-2xl">
                ...
                <div className="mt-6 grid gap-3" aria-label="Festival selection update">
                  {false && (<article className="relative overflow-hidden rounded-[22px] border border-[#2457d6]/20 bg-[linear-gradient(135deg,#eff6ff_0%,#ffffff_70%)] p-4 shadow-[0_12px_28px_rgba(36,87,214,0.08)] sm:p-5" aria-hidden="true">
