...
const hindiText: Record<string, string> = {
  ...
  'Shop on K-Food.in': 'K-Food.in पर खरीदारी करें',
  'K-Food.in Shop': 'K-Food.in दुकान',
  ...
  'Korean food content that connects to K-Food.in': 'K-Food.in से जुड़ने वाला कोरियाई भोजन कंटेंट',
  ...
  'K-CUBE handles discovery and points. K-Food.in handles shopping and product purchase journeys.': 'के-क्यूब खोज और पॉइंट्स संभालता है। K-Food.in खरीदारी और उत्पाद खरीद यात्रा संभालता है।',
  ...
  'K-CUBE.store drives engagement. K-Food.in captures commerce. Points connect both and build the Korea trip race.': 'K-CUBE.store एंगेजमेंट बढ़ाता है। K-Food.in कॉमर्स संभालता है। पॉइंट्स दोनों को जोड़कर कोरिया यात्रा रेस बनाते हैं।',
  ...
  'Connect recipe intent to K-Food.in purchases.': 'रेसिपी रुचि को K-Food.in खरीदारी से जोड़ें।',
  ...
  'Track K-Food.in click intent for admin insights.': 'एडमिन इनसाइट्स के लिए K-Food.in क्लिक रुचि ट्रैक करें।',
  ...
  'Recipes, food missions and K-Food.in commerce bridge.': 'रेसिपी, फूड मिशन और K-Food.in कॉमर्स कनेक्शन।',
  ...
  'Recipes and food content guide users toward K-Food.in purchases.': 'रेसिपी और फूड कंटेंट उपयोगकर्ताओं को K-Food.in खरीदारी की ओर ले जाते हैं।',
...
export const detailItems: DetailItem[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      txt('Connect recipe intent to K-Food.in purchases.', '레시피 관심을 K-Food.in 구매로 연결합니다.', 'Recipe intent ko K-Food.in purchase se connect karein.'),
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          txt('Discover how recipe interest can connect to K-Food.in product journeys, making it easier to source ingredients and shop Korean food items.', '레시피 관심이 K-Food.in 제품 여정과 어떻게 연결되어 한국 식재료를 쉽게 구매할 수 있는지 알아보세요.', 'Discover how recipe interest connects to K-Food.in and shopping for Korean ingredients.'),
  ...
  },
  {
    ...
    bullets: [
      ...
      txt('Track K-Food.in click intent for admin insights.', 'K-Food.in 클릭 의도를 관리자 인사이트로 추적합니다.', 'K-Food.in click intent admin insights mein track hoga.'),
    ],
    sections: [
      {
