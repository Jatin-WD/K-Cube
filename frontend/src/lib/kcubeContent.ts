...
const hindiText: Record<string, string> = {
  ...
  'Beginner Korean, vocabulary streaks, and speaking practice are separate bite-sized learning paths.': 'शुरुआती कोरियाई, शब्दावली स्ट्रीक और बोलने का अभ्यास छोटे-छोटे सीखने के रास्ते हैं।',
  ...
  'Bite-sized Korean lessons with points-based progress.': 'पॉइंट-आधारित प्रगति वाले छोटे-छोटे कोरियाई लेसन।',
...
export const pages: Record<PageKey, PageContent> = {
  home: {
    ...
    cards: [
      ...
      { title: txt('Korean learning', '한국어 학습', 'Korean learning'), description: txt('Bite-sized Korean lessons with points-based progress.', '포인트 기반 진도로 이어지는 짧고 실용적인 한국어 수업.', 'Bite-sized Korean lessons with points progress.'), href: '/learning', cta: txt('Start learning', '학습 시작', 'Learning start karein') },
  ...
  learning: {
    ...
    subtitle: txt('Beginner Korean, vocabulary streaks, and speaking practice are separate bite-sized learning paths.', '초급 한국어, 단어 연속 학습, 말하기 연습을 짧고 실용적인 학습 경로로 만나보세요.', 'Beginner Korean, vocabulary streaks aur speaking practice chhote learning paths mein explore karein.'),
